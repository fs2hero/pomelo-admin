...
MasterAgent.prototype.listen = function(port, cb) {
  ...
  this.server.on('connection', function(socket) {
    ...
    socket.on('register', function(msg) {
      ...
      logger.debug('Monitor/Client register ');
      logger.debug('msg ',JSON.stringify(msg));

      masterSocket.onRegister(msg);
      logger.debug('id:',masterSocket.id,' ,type: ',masterSocket.type,',info: ',masterSocket.info);
    }); // end of on 'register'
    ...
    socket.on('reconnect', function(msg) {
      logger.debug('reconnect id:',masterSocket.id,' ,type: ',masterSocket.type,',info: ',masterSocket.info);
      logger.debug('msg ',JSON.stringify(msg));
    ...
    socket.on('disconnect', function() {
      logger.debug('disconnect id:',masterSocket.id,' ,type: ',masterSocket.type,',info: ',masterSocket.info);

      masterSocket.onDisconnect();
    });

    socket.on('close', function() {
      logger.debug('close id:',masterSocket.id,' ,type: ',masterSocket.type,',info: ',masterSocket.info);

      masterSocket.onDisconnect();
    });

    socket.on('error', function(err) {
      logger.debug('error id:',masterSocket.id,' ,type: ',masterSocket.type,',info: ',masterSocket.info);
